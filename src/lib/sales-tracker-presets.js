...
// price override), so it gets its own small, dependency-free module. The
// storage/id rules both preset lists share live in ./fair-presets.js.
...
const stStore = createPresetStore({ storageKey: ST_PRESET_STORAGE_KEY, normalize: normalizeStPreset });
export const loadStPresets = stStore.load;
export const saveStPresets = stStore.save;
export const upsertStPreset = stStore.upsert;
export const removeStPreset = stStore.remove;
export const findStPreset = stStore.find;
