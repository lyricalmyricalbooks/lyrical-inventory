...
| 2026-09-10 | visual | Book dashboard | Gave the Break-even tracker a real heading like its dashboard siblings, instead of the faintest type in the app | (this PR) |
