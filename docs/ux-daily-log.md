...
| 2026-09-22 | visual | Book dashboard — Danger zone | Gave the "Danger zone" section a real heading and a warm red warning colour instead of the same faint caption every other section on the page had already moved on from | #TBD |
