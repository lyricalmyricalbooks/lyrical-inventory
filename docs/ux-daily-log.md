...
| 2026-09-22 | visual | Book dashboard — Danger zone | Gave the "Danger zone" section a real heading and a warm red warning colour instead of the same faint caption every other section on the page had already moved on from | #875 |
...
| 2026-09-24 | visual | Shipping — Shippo rate list | Made the Shippo rate cards match the Canada Post rows beside them: a full-size Buy Label button instead of a squeezed tiny one, prices in plain ink instead of green on every row, a colour for the "Canada Post" tag, and the same lift on hover | TBD |
