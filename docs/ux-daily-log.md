...
| 2026-09-11 | visual | Book dashboard | Gave the Profit Sharing Breakdown card a real heading like its dashboard siblings, instead of the faintest type in the app | (this PR) |
