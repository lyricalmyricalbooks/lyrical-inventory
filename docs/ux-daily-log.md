...
| 2026-09-23 | visual | Settings — Book Catalog | Stopped each book's Edit/Remove buttons from getting squeezed off the edge of the screen on a phone held upright | (this run) |
