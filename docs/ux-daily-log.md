...
| 2026-09-05 | visual | Order History, Consignment ledger | Made the row-edit pencil button visible when you tab to it with a keyboard, not just when you hover the row | (pending) |
