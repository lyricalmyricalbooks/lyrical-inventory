...
| 2026-09-16 | visual | Settings — Website Payment Methods | Gave the Stripe/PayPal/Interac/Cash toggle switches a visible focus ring for keyboard users, instead of one hidden on an invisible point | #TBD |
